...
file_path = 'reg_key_output_json_file.json'
file_path_2 = 'reg_key_output_json_file_2.json'
output_path_1 = 'reg_key_dedup_json_file.json'
output_path_2 = 'reg_key_re_format_file.json'
