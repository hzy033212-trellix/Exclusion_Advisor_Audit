...
file_path = 'image_load_output_json_file.json'
file_path_2 = 'image_load_output_json_file_2.json'
output_path_1 = 'image_load_dedup_json_file.json'
output_path_2 = 'image_load_re_format_file.json'
